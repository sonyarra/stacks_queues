...
### Queue
Очередь (queue) - это структура данных, обеспечивающая добавление элементов в конец очереди и извлечение элементов с ее начала. Работает по принципу "First In, First Out".

![queue](./pictures/queue.jpg)

### Stack
Стек (stack) - это структура данных, обеспечивающая вставку элемента в вершину стека и удаление элемента из его вершины. Работает по принципу "Last In, First Out".
